...
class _UploadPageState extends State<UploadPage> with AutomaticKeepAliveClientMixin<UploadPage>{
  ...
  displayUploadScreen(){
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Icon(Icons.add_photo_alternate, color: Colors.white,size: 200.0,),
          Padding(
  ...
  Future<String> uploadPhoto(mImageFile) async{
    StorageUploadTask mStorageTask = storageReference.child("post_$postId.jpg").putFile(mImageFile);
    String downloadUrl = await (await mStorageTask.onComplete).ref.getDownloadURL();
    return downloadUrl;
  }
